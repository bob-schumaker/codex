...
mod tests {
    ...
    fn event_requires_delivery_marks_transcript_and_terminal_events() {
        ...
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(Box::new(
                codex_app_server_protocol::ServerNotification::ControllerAuthorizationChanged(
                    codex_app_server_protocol::ControllerAuthorizationChangedNotification {
                        ...
                        reason:
                            codex_app_server_protocol::ControllerAuthorizationChangedReason::Approved,
        ...
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(Box::new(
                codex_app_server_protocol::ServerNotification::ControllerControlOwnershipChanged(
